...
export default function Navbar() {
    ...
    return (
        <div className='px-10 sm:px-4 2xl:px-24 3xl:px-32'>
            <nav className=' w-full  flex items-center justify-between lg:justify-normal p-4 3xl:px-10 shadow-xl shadow-saydam rounded-xl '>
                ...
                <div className={classNames(`absolute z-50 pl-10 lg:pl-0 overflow-hidden w-full h-0 flex flex-col  px-1  bg-[#ffffff] backdrop-blur-md left-0 top-[110px]  transition-all ease-out duration-500 
            lg:static lg:overflow-visible lg:min-h-fit lg:translate-y-0 lg:bg-transparent lg:w-full lg:flex lg:flex-row justify-center lg:items-center  
            ...
            [&>*:nth-child(4)]:py-2 [&>*:nth-child(4)]:text-[#fff] `, {
                    "absolute  transition-all h-[50vh] shadow-xl shadow-[#4444] border rounded-3xl gap-y-4 py-4 font-bold": open === true,
                })}>
